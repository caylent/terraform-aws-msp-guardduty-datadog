...
output "datadog_connection_arns" {
  ...
  value = merge(
    ...
    (length(module.ap_east_2) > 0 ? { "ap-east-2" = module.ap_east_2[0].datadog_connection_arn } : {}),
    ...
    (length(module.ap_southeast_6) > 0 ? { "ap-southeast-6" = module.ap_southeast_6[0].datadog_connection_arn } : {}),
...
output "datadog_api_destination_arns" {
  ...
  value = merge(
    ...
    (length(module.ap_east_2) > 0 ? { "ap-east-2" = module.ap_east_2[0].datadog_api_destination_arn } : {}),
    ...
    (length(module.ap_southeast_6) > 0 ? { "ap-southeast-6" = module.ap_southeast_6[0].datadog_api_destination_arn } : {}),
...
output "guardduty_to_datadog_rule_arns" {
  ...
  value = merge(
    ...
    (length(module.ap_east_2) > 0 ? { "ap-east-2" = module.ap_east_2[0].guardduty_to_datadog_rule_arn } : {}),
    ...
    (length(module.ap_southeast_6) > 0 ? { "ap-southeast-6" = module.ap_southeast_6[0].guardduty_to_datadog_rule_arn } : {}),
...
output "dlq_arns" {
  ...
  value = merge(
    ...
    (length(module.ap_east_2) > 0 ? { "ap-east-2" = module.ap_east_2[0].dlq_arn } : {}),
    ...
    (length(module.ap_southeast_6) > 0 ? { "ap-southeast-6" = module.ap_southeast_6[0].dlq_arn } : {}),
